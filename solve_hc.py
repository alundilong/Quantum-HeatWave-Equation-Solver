...
# -------- IMPORTS --------
# Own modules
from simulation.experiment_hc import ForwardExperiment1D
...
def main() -> None:
    ...
    parameters = {
        ...
        'alpha': homogeneous(alpha, nx+1),                  # thermal diffusivity distribution
        'u': spike(1, nx, nx//2+1),                         # Initial temperature
        'v': homogeneous(0, nx),                            # Initial temperature change rate
        'backend': {
            'synthesis': synthesis,                         # Time Evolution Synthesis Method
