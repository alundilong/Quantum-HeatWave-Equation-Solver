...
# -------- FUNCTIONS --------
def plot_multi(data, idx, shots=None, colors=['black', 'red', 'blue', 'green', 'purple', 'gray', 'yellow','orange']):
    """
    ...
    for i, d in enumerate(data):
        ...
        if d['settings']['solver'] == 'ode':
            ...
            solv_list.append(f'Imaginary Quantum Solver {apx}')
        elif d['settings']['solver'] == 'split':
            solv_list.append(f'Split Simulator {apx}')
